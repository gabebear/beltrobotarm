...
void setup()
{
  ...
  stepperHigher.setReductionRatio(90.0 / 20.0, 200 * 16); //big gear: 32, small gear: 9, steps per rev: 200, microsteps: 16
  stepperLower.setReductionRatio(90.0 / 20.0, 200 * 16);  //(32.0 / 9.0, 200 * 16)
  stepperRotate.setReductionRatio(90.0 / 20.0, 200 * 16);
  stepperExtruder.setReductionRatio(90.0 / 20.0, 200 * 16);
...
void cmdPumpOn(Cmd(&cmd))
{
  digitalWrite(PUMP_PIN, HIGH);
}

void cmdPumpOff(Cmd(&cmd))
{
